System.register(['angular2/core', 'angular2/http', 'rxjs/Rx', 'angular2/router', './home/welcome.component', './wpf/wpf.component', './sqlite/sqlite.component', './xamarin/xamarin.component', './angular2/angular2.component', './typescript/typescript.component', './javascript/javascript.component', './jquery/jquery.component', './bootstrap/bootstrap3.component', './visualstudio/visualstudio.component', './visualstudiocode/visualstudiocode.component', './emmet/emmet.component', './csharp/csharp.component', './odata/odata.component', './dgen/dgen.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, welcome_component_1, wpf_component_1, sqlite_component_1, xamarin_component_1, angular2_component_1, typescript_component_1, javascript_component_1, jquery_component_1, bootstrap3_component_1, visualstudio_component_1, visualstudiocode_component_1, emmet_component_1, csharp_component_1, odata_component_1, dgen_component_1;
    ...
    return {
        setters:[
            ...
            function (sqlite_component_1_1) {
                sqlite_component_1 = sqlite_component_1_1;
            },
            function (xamarin_component_1_1) {
                xamarin_component_1 = xamarin_component_1_1;
            },
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/sqlite', name: 'Sqlite', component: sqlite_component_1.SqliteComponent },
                        { path: '/xamarin', name: 'Xamarin', component: xamarin_component_1.XamarinComponent },
                        { path: '/xamarin-forms-cross-platform-00-course-contents', name: 'XamarinFormsCrossPlatform00CourseContents', component: xamarin_component_1.XamarinFormsCrossPlatform00CourseContentsComponent },
                        { path: '/xamarin-forms-cross-platform-01-getting-started', name: 'XamarinFormsCrossPlatform01GettingStarted', component: xamarin_component_1.XamarinFormsCrossPlatform01GettingStartedComponent },
                        { path: '/xamarin-forms-cross-platform-02-xaml-essentials', name: 'XamarinFormsCrossPlatform02XAMLEssentials', component: xamarin_component_1.XamarinFormsCrossPlatform02XAMLEssentialsComponent },
                        { path: '/xamarin-forms-cross-platform-03-layouts', name: 'XamarinFormsCrossPlatform03Layouts', component: xamarin_component_1.XamarinFormsCrossPlatform03LayoutsComponent },
                        { path: '/xamarin-forms-cross-platform-04-images', name: 'XamarinFormsCrossPlatform04Images', component: xamarin_component_1.XamarinFormsCrossPlatform04ImagesComponent },
                        { path: '/xamarin-forms-cross-platform-05-lists', name: 'XamarinFormsCrossPlatform05Lists', component: xamarin_component_1.XamarinFormsCrossPlatform05ListsComponent },
                        { path: '/xamarin-forms-cross-platform-06-navigation', name: 'XamarinFormsCrossPlatform06Navigation', component: xamarin_component_1.XamarinFormsCrossPlatform06NavigationComponent },
                        { path: '/xamarin-forms-cross-platform-07-forms-and-settings-pages', name: 'XamarinFormsCrossPlatform07FormsAndSettingsPages', component: xamarin_component_1.XamarinFormsCrossPlatform07FormsAndSettingsPagesComponent },
                        { path: '/xamarin-forms-cross-platform-08-data-access', name: 'XamarinFormsCrossPlatform08DataAccess', component: xamarin_component_1.XamarinFormsCrossPlatform08DataAccessComponent },
                        { path: '/xamarin-forms-cross-platform-09-model-view-viewmodel-architectural-pattern', name: 'XamarinFormsCrossPlatform09ModelViewViewModelArchitecturalPattern', component: xamarin_component_1.XamarinFormsCrossPlatform09ModelViewViewModelArchitecturalPatternComponent },
                        { path: '/xamarin-forms-cross-platform-10-getting-started', name: 'XamarinFormsCrossPlatform10BeyondTheBasics', component: xamarin_component_1.XamarinFormsCrossPlatform10BeyondTheBasicsComponent },
